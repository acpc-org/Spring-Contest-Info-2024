        ...
        <div className="flex flex-col gap-8 my-28">
            ...
            <ol className="list-decimal">
                <li className="mb-8">
                    ...
                    <p>
                        The contest is online, run on the Codeforces platform.  
                        You must sign up for 
                        a <a href="https://codeforces.com" target="_blank" rel="noopener noreferrer" className="underline decoration-dashed hover:decoration-solid">
                            codeforces.com
                        </a> account 
                        and use it when 
                        you register for the contest. If you have one already, just use that one.
                    </p>
                </li>
                <li className="mb-8">
                    <h2 className="text-lg font-bold uppercase">Make a Codeforces Team (OPTIONAL)</h2>
                    <p>
                        The contest is a team competitive programming contest. 
                        You may compete in teams of up to three people. If you plan on doing so, you must
                        create a team
                        on <a href="https://codeforces.com" target="_blank" rel="noopener noreferrer" className="underline decoration-dashed hover:decoration-solid">
                            codeforces.com
                        </a> before 
                        the contest.
                    </p>
                ...
                <li className="mb-8">
                    ...
                    <p>
                        Sign up using the Google Form below (also available
                        at <a href="https://tamuacpc.com/about" target="_blank" rel="noopener noreferrer" className="underline decoration-dashed hover:decoration-solid ">
                            tx.ag/spring24register
                        </a>). You must sign up by April 13th at 11:59 PM. Each teammate should fill out the form.
                    </p>
                    <div className="bg-neutral-800 py-4 rounded-lg mt-4">
                        <iframe src="https://docs.google.com/forms/d/e/1FAIpQLSfiz-PEIkiBFqfuDF-nIJPLsbDpq-2UMnAQuGi1EJyHkah47w/viewform?embedded=true" width="640" height="4122" className="w-full">Loading…</iframe>
                    </div>
                </li>
                <li className="mb-8">
